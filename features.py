...
from util import visualize_one_image
...
def hog_feature(im, cell_sz = 8, show_im = False):
  """Compute Histogram of Gradient (HOG) feature for an image
    ...
    Parameters:
      ...
      cell_sz : cell_sz * cell_sz pixels per cell
  ...
  cx, cy = (cell_sz, cell_sz) # pixels per cell
  ...
  if show_im: 
    imageplot = plt.imshow(orientation_histogram)
